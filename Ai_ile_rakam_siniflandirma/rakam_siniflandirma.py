...
# cv2.imshow("Preproces", img)

x_train = np.array(list(map(preProcess, x_train)))
x_test = np.array(list(map(preProcess, x_train)))
x_validation = np.array(list(map(preProcess, x_train)))
...
sns.heatmap(cm, annot = True, linecwidth = 0.01, cmap = "Greens", linecolor = "gray", fmt = ".1f", ax = ax)
