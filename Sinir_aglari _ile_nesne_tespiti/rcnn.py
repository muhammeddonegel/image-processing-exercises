...
from slinding_window import sliding_window
from image_pyramid import image_pyramid
from non_max_supprssion import non_max_suppression

#ilklendirme paramatreleri
WIDTH = 600
HEIGHT = 600
PYR_SCALE = 1.5
WIN_STEP = 16
...
orig = cv2.imread("kedi.jpg")
orig = cv2.resize(orig, dsize = (WIDTH, HEIGHT))
cv2.imshow("kedi", orig)
